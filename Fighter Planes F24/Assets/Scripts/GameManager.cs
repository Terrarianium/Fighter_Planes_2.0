...
public class GameManager : MonoBehaviour
{
    ...
    void CreateEnemyTwo()
    {
        Instantiate(enemyTwo, new Vector3(Random.Range(9f, 18f), 7.5f, 0), Quaternion.Euler(0, 0, 135));
    }
    ...
    void CreateCoin()
    {
        Instantiate(coin, new Vector3(Random.Range(-9f, 9f), Random.Range(-6f, 0), 0), Quaternion.identity);
    }
